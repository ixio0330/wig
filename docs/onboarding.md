...
2. 상세 기능 설계(점수판, 위젯 시스템, 워크스페이스 계층 등) 및 **데이터베이스 스키마 설계** 완료.
   - `docs/dev/2026.03.09-database-schema.md`
3. **프론트엔드 프로토타입 제작** 단계 진입 (Mock Data 기반 UX 검증).
   - `docs/prototype/2026.03.09-prototype-plan.md`
4. 프로토타입 검증 후 실제 기능 개발 진행 예정.
